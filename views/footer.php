<footer>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-4">
                    <div class="description">
                        ...
                        <p class="text">
                            ...
                            solicitude travelling and one contrasted.
                            Fortune day out married parties. Happiness
                            remainder joy but earnestly for off.
                ...
                <div class="col-2">
                    ...
                    <ul class="list-menu">
                        <li><a class="subtitle" href="#">Mon - Fri: 8AM
                                - 10PM</a></li>
    ...
    <div class="credentials">
        <div class="container">
            <div class="row">
                <div class="col-auto">
                    <p class="subtitle">Hyperion 2021 Created By Name
                        Studio</p>
                </div>

                <div class="col-right display-flex subtitle scheme-dark gap">
